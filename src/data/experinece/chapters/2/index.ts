...
const data : Chapter = {
	...
	text: {
		...
		bg: "След като идеята е придобила форма, е време да съберем елементите, които ще ѝ вдъхнат живот. Това означава да открием уединено, спокойно място, да подберем дрехи и реквизит и да определим датата, на която всичко ще се случи. Всеки детайл е съобразен с тона и автентичността на твоята история. Така изграждаме онази среда, в която преживяването ти може да се разгърне пълноценно и автентично."
	},
	background: {
