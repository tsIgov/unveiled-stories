...
export const load: PageLoad = (async ({ parent }) => {
	...
	return {
		...
		texts: {
			...
			planningHeader: translator({
				en: "Planning",
				bg:"Планиране"
			}),
			planningParagraph: translator({
			...
			preparationHeader: translator({
				en: "Preparation",
				bg:"Подготовка"
			}),
			preparationParagraph: translator({
			...
			theShootHeader: translator({
				en: "The Shoot",
				bg: "Сесията"
			}),
			theShootParagraph: translator({
			...
			theRevealHeader: translator({
				en: "The Reveal",
				bg: ""
			}),
			theRevealParagraph: translator({
